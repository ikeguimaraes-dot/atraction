...
select set_config('request.jwt.claims','{"sub":"00000000-0000-4000-8000-00000000ed01","role":"authenticated","aal":"aal1"}',true);
insert into public.atraction_finance(tenant_id,title,direction,amount_cents,category,due_date) values('00000000-0000-4000-8000-00000000ed02','Password access','expense',100,'Taxas',current_date);
select 'installments atomic save, totals and password access passed' as result;
rollback;
