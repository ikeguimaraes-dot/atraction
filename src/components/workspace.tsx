              ...
              {wonOffer && canManage && (
                <section className="card journey-offer">
                  <div>
                    ...
                    <p>
                      Transforme {wonOffer.title} em contrato, contas a receber
                      e pós-venda.
                    </p>
                  </div>
                  <button
                  ...
                  <div className="today-grid">
                      ...
                      <div className="today-list">
                        {unread.slice(0, 3).map((c) => {
                          const last = messages
                            .filter(
                              (m) =>
                                m.contact_id === c.id && m.direction === "in",
                            )
                            .sort((a, b) =>
                    ...
                    <section className="card today-card wins-card">
                      <header>
                        ...
                        <span className="chip green-chip">
                          {ui.ultimos_7_dias}
                        </span>
                      </header>
                      ...
                      return (
                        <section
                          ...
                          onDrop={(e) => {
                            ...
                            const d = deals.find(
                              (d) =>
                                d.id === e.dataTransfer.getData("text/plain"),
                            );
                        ...
                        >
                          ...
                          <p className="column-value">
                            {money(
                              rows.reduce((n, d) => n + Number(d.value), 0),
                            )}
                          </p>
                          {rows.map((d) => (
                            <article
                            ...
                            >
                              ...
                              <select
                                aria-label={
                                  ui.etapa_de + contactName(d.contact_id)
                                }
                                value={d.stage}
                                disabled={!canWrite || w.busy}
                                onChange={(e) =>
                    ...
                    <section className="card capture-editor">
                      ...
                      {s.tenant.capture_enabled && (
                        <button
                          ...
                          onClick={() =>
                            w.updateTenant({ capture_enabled: false })
                          }
                        >
                          {ui.pausar_pagina}
                        </button>
                      ...
                      <div className="qr-block">
                        {qr && (
                          <img
                            src={qr}
                            alt={ui.qr_code_da_pagina_de_captacao}
                          />
                        )}
                        <div>
                  ...
                  <div className="settings-grid">
                    ...
                    <section className="card settings-card">
                      ...
                      <button
                        className="secondary"
                        onClick={() =>
                          isDemo ? w.setAuthOpen(true) : w.logout()
                        }
                      >
